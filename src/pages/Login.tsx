    ...
    <div className="min-h-screen bg-[#050505] flex items-center justify-center px-4">
      <div className="w-full max-w-[400px] space-y-8">
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-[#A1A1AA] font-light">Sign in to your account to continue</p>
        </div>

        <div className="border border-[#1A1A1C] bg-[#0A0A0C] p-8 space-y-6">
          <Button
            type="button"
            variant="outline"
            className="w-full h-11 border-[#1A1A1C] text-[#FAFAFA] hover:bg-[#1A1A1C] text-[10px] font-bold uppercase tracking-widest"
          ...
          <div className="relative">
            <div className="absolute inset-0 flex items-center">
              <span className="w-full border-t border-[#1A1A1C]" />
            </div>
            <div className="relative flex justify-center text-[10px] uppercase">
              <span className="bg-[#0A0A0C] px-3 text-[#A1A1AA] tracking-widest">or</span>
            </div>
          </div>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="flex justify-end">
                <Link
                  to="/forgot-password"
                  className="text-[10px] text-[#38BDF8] hover:text-[#7dd3fc] uppercase tracking-widest font-medium transition-colors"
                >
                  Forgot password?
                </Link>
              </div>
