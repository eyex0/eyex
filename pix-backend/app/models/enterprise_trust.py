...
from sqlalchemy import Uuid, text, Boolean, DateTime, Float, ForeignKey, Integer, String, Text
...
class AIGovernancePolicy(Base):
    ...
    action_types: Mapped[list[str]] = mapped_column(JSONBCompat, default=list)
    ...
    approver_roles: Mapped[list[str]] = mapped_column(JSONBCompat, default=list)
    max_auto_approve_value: Mapped[float | None] = mapped_column(Float, nullable=True)
    rules: Mapped[dict] = mapped_column(JSONBCompat, default=dict)
...
class AIActionRequest(Base):
    ...
    input_data: Mapped[dict] = mapped_column(JSONBCompat, default=dict)
    proposed_action: Mapped[dict] = mapped_column(JSONBCompat, default=dict)
    estimated_impact: Mapped[dict] = mapped_column(JSONBCompat, default=dict)
    explanation: Mapped[str | None] = mapped_column(Text, nullable=True)
    approved_by: Mapped[str | None] = mapped_column(Uuid, nullable=True)
    approved_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    executed_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    execution_result: Mapped[dict | None] = mapped_column(JSONBCompat, nullable=True)
...
class AIApprovalWorkflow(Base):
    ...
    name: Mapped[str] = mapped_column(String(256), nullable=False)
    description: Mapped[str | None] = mapped_column(Text, nullable=True)
    trigger_action_types: Mapped[list[str]] = mapped_column(JSONBCompat, default=list)
    trigger_risk_levels: Mapped[list[str]] = mapped_column(JSONBCompat, default=list)
    is_active: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    steps: Mapped[list[dict]] = mapped_column(JSONBCompat, default=list)
...
class AIApprovalDecision(Base):
    ...
    request_id: Mapped[str] = mapped_column(
        Uuid, ForeignKey("ai_action_requests.id"), nullable=False, index=True
    )
    step_number: Mapped[int] = mapped_column(Integer, nullable=False)
    decision: Mapped[str] = mapped_column(String(50), nullable=False)
    decided_by: Mapped[str] = mapped_column(Uuid, nullable=False)
    decided_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), default=_utcnow, server_default=text("CURRENT_TIMESTAMP"))
...
class HumanReviewTask(Base):
    ...
    request_id: Mapped[str | None] = mapped_column(
        Uuid, ForeignKey("ai_action_requests.id"), nullable=True
    )
    ...
    context: Mapped[dict] = mapped_column(JSONBCompat, default=dict)
...
class ExplainableAIReport(Base):
    ...
    reasoning_steps: Mapped[list[dict]] = mapped_column(JSONBCompat, default=list)
    evidence: Mapped[list[dict]] = mapped_column(JSONBCompat, default=list)
    confidence_score: Mapped[float] = mapped_column(Float, default=0.0)
    input_features: Mapped[dict] = mapped_column(JSONBCompat, default=dict)
    output_explanation: Mapped[str | None] = mapped_column(Text, nullable=True)
    limitations: Mapped[list[str]] = mapped_column(JSONBCompat, default=list)
...
class IdentityProvider(Base):
    ...
    config: Mapped[dict] = mapped_column(JSONBCompat, default=dict)
    is_active: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
...
class SecurityAlert(Base):
    ...
    resolved_by: Mapped[str | None] = mapped_column(Uuid, nullable=True)
    evidence: Mapped[dict] = mapped_column(JSONBCompat, default=dict)
...
class DataIsolationRule(Base):
    ...
    allowed_roles: Mapped[list[str]] = mapped_column(JSONBCompat, default=list)
    denied_roles: Mapped[list[str]] = mapped_column(JSONBCompat, default=list)
    conditions: Mapped[dict] = mapped_column(JSONBCompat, default=dict)
    is_active: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    meta_data: Mapped[dict | None] = mapped_column(JSONBCompat, nullable=True)
...
class AgentHealthCheck(Base):
    ...
    checked_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), default=_utcnow, server_default=text("CURRENT_TIMESTAMP"))
    diagnostics: Mapped[dict | None] = mapped_column(JSONBCompat, nullable=True)
...
class AgentPerformanceScore(Base):
    ...
    factors: Mapped[dict] = mapped_column(JSONBCompat, default=dict)
...
class BusinessImpactMetric(Base):
    ...
    attribution: Mapped[dict] = mapped_column(JSONBCompat, default=dict)
...
class DecisionImprovementMetric(Base):
    ...
    examples: Mapped[list[dict]] = mapped_column(JSONBCompat, default=list)
...
class RiskPreventionMetric(Base):
    ...
    details: Mapped[list[dict]] = mapped_column(JSONBCompat, default=list)
...
class AgentVersion(Base):
    ...
    configuration: Mapped[dict] = mapped_column(JSONBCompat, default=dict)
    prompt_template: Mapped[str | None] = mapped_column(Text, nullable=True)
    tools: Mapped[list[str]] = mapped_column(JSONBCompat, default=list)
...
class AgentTestRun(Base):
    ...
    agent_version_id: Mapped[str] = mapped_column(
        Uuid, ForeignKey("agent_versions.id"), nullable=False, index=True
    )
    ...
    results: Mapped[list[dict]] = mapped_column(JSONBCompat, default=list)
...
class AgentDeployment(Base):
    ...
    deployed_by: Mapped[str] = mapped_column(Uuid, nullable=False)
...
class IntegrationSync(Base):
    ...
    connector_id: Mapped[str] = mapped_column(
        Uuid, ForeignKey("enterprise_connectors.id"), nullable=False, index=True
    )
...
class CertifiedAgent(Base):
    ...
    certified_by: Mapped[str | None] = mapped_column(Uuid, nullable=True)
    ...
    compliance_tags: Mapped[list[str]] = mapped_column(JSONBCompat, default=list)
...
class DeveloperApplication(Base):
    ...
    reviewed_by: Mapped[str | None] = mapped_column(Uuid, nullable=True)
    reviewed_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    portfolio: Mapped[dict] = mapped_column(JSONBCompat, default=dict)
