...
This is the backend for the EyeX Technologies platform. It's a Python-based application built with FastAPI that powers the AI agents, business intelligence, and data processing capabilities of EyeX.
